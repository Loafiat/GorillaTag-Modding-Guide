...
![Monke Mod Manager logo](GorillaTag-Modding-Guide/docs/files/mmmlogo.png)
...
![Right-click Menu Preview](GorillaTag-Modding-Guide/docs/files/localfilescontext.png)

2. Click the address bar at the top to select your installation folder's path. Hit `CTRL`+`C` to copy this to your clipboard.  

![Copy Folder Path Preview](GorillaTag-Modding-Guide/docs/files/copyfolderpath.png)
...
![BepInEx Folder Preview](GorillaTag-Modding-Guide/docs/files/bepinexfolder.png)
